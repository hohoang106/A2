...
<html lang="">
	...
	<body>
		...
		<?php if (empty($products)) echo 'Not found'; ?>
		...
		<div class="thumbnail">
			...
			<p class="thumbdetail">
				<a href="./detail.php?productid=<?php echo $value['productid']?>"><span style="font-weight: bold; font-size: 15px;"><?php echo $value['productname']?></span></a> <br><span style="font-weight: bold;">Price:</span> <span style="font-weight: bold; color: #0078D6;">$<?php echo $value['price']?></span> <br>Manchester Ave, Los Angeles, United States <br>Phone: 123 456 789
			</p>
		</div>
		<?php endforeach;?>
